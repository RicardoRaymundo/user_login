...
const double ppfMinInteractiveDimension = 30.0;

const Duration _kDropdownMenuDuration = Duration(milliseconds: 300);
//const double _kMenuItemHeight = kMinInteractiveDimension;
const double _kMenuItemHeight = ppfMinInteractiveDimension;
//Zconst double _kDenseButtonHeight = 24.0;
...
class _DropdownMenuState<T> extends State<_DropdownMenu<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> children = listDropdownMenuItemButton(widget.route);
  ...
  List<Widget> listDropdownMenuItemButton(route) {
    List<Widget> result = [];
    for (int itemIndex = 0; itemIndex < route.items.length; ++itemIndex) {
      result.add(_DropdownMenuItemButton<T>(
        route: widget.route,
        padding: widget.padding,
...
class _DropdownRoute<T> extends PopupRoute<_DropdownRouteResult<T>> {
  _DropdownRoute({
    ...
    this.itemHeight,
        ...
        itemHeights = List<double>.filled(items.length, itemHeight ?? ppfMinInteractiveDimension);
...
class DropdownButton<T> extends StatefulWidget {
  ...
  DropdownButton({
    ...
    this.itemHeight = ppfMinInteractiveDimension,
    this.focusColor,
    this.focusNode,
    this.autofocus = false,
        ...
        assert(itemHeight == null || itemHeight >= ppfMinInteractiveDimension),
        super(key: key);
...
class _DropdownButtonState<T> extends State<DropdownButton<T>> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    //TODO:: Implementar esse padding = 0 depois de consertar a área clicavel
    //EdgeInsets.all(0);
